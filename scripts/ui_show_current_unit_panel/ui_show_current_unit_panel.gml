...

{
	var l19106090_0 = 40;
	var l19106090_1 = 40;
	draw_text(l19106090_0, l19106090_1, string("Name: ") + string(ds_grid_get(global.charstat, global.uiactivechar, 0)));
}
...

{
	var l0C133CAA_0 = 40;
	var l0C133CAA_1 = 100;
	draw_text(l0C133CAA_0, l0C133CAA_1, string("Strength: ") + string(ds_grid_get(global.charstat, global.uiactivechar, 5)));
}
...

{
	var l1E553DBF_0 = 40;
	var l1E553DBF_1 = 120;
	draw_text(l1E553DBF_0, l1E553DBF_1, string("Intelligence: ") + string(ds_grid_get(global.charstat, global.uiactivechar, 6)));
}
...

{
	var l78F521A1_0 = 40;
	var l78F521A1_1 = 140;
	draw_text(l78F521A1_0, l78F521A1_1, string("Constitution: ") + string(ds_grid_get(global.charstat, global.uiactivechar, 7)));
}
...

{
	var l132E54EC_0 = 40;
	var l132E54EC_1 = 160;
	draw_text(l132E54EC_0, l132E54EC_1, string("Agility: ") + string(ds_grid_get(global.charstat, global.uiactivechar, 8)));
}
...

{
	var l701BD9FC_0 = 40;
	var l701BD9FC_1 = 180;
	draw_text(l701BD9FC_0, l701BD9FC_1, string("Dexterity: ") + string(ds_grid_get(global.charstat, global.uiactivechar, 9)));
}
...

{
	var l623040A1_0 = 40;
	var l623040A1_1 = 200;
	draw_text(l623040A1_0, l623040A1_1, string("Piety: ") + string(ds_grid_get(global.charstat, global.uiactivechar, 10)));
}
