...
while(true)
{
	...
	while(true)
	{
			...
			if(global.newchar >= 0)
			{
						...
						/// @DnDHash : 0334E2B6
						/// @DnDParent : 32158E6F
						/// @DnDArgument : "expr" "battlemapx * global.world_tile_size + (global.world_tile_size / 2)"
						/// @DnDArgument : "var" "placementx"
						placementx = battlemapx * global.world_tile_size + (global.world_tile_size / 2);
						...
						/// @DnDHash : 5EBA3B1E
						/// @DnDParent : 32158E6F
						/// @DnDArgument : "expr" "battlemapy * global.world_tile_size + (global.world_tile_size / 2)"
						/// @DnDArgument : "var" "placementy"
						placementy = battlemapy * global.world_tile_size + (global.world_tile_size / 2);
						...
						if(global.newchar >= 0)
						{
										...
										if(global.newchar <= 19)
										{
															...
															/// @DnDArgument : "layer" ""Characters""
															/// @DnDSaveInfo : "objectid" "ff5c3ffe-075f-41af-8a9a-986497f401fe"
