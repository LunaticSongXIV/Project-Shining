...
/// @DnDVersion : 1
/// @DnDHash : 350A7F37
/// @DnDArgument : "msg" ""Received UE 1""
show_debug_message(string("Received UE 1"));
...
if(global.active_turn_char == myself)
{
	...
	/// @DnDHash : 4E2ADDA3
	/// @DnDParent : 79BB0228
	/// @DnDArgument : "msg" ""Verified Player Turn""
	show_debug_message(string("Verified Player Turn"));
